...
def scrape_all_reviews_on_page(review_total_element):
    for review in review_total_element.find_elements_by_css_selector("div[class='a-section celwidget']"):
        ...
        review_contributor = soup.find('a', attrs={'class': 'a-link-normal enthusiast-badge aok-nowrap'})
        review_top_contrib = 'top' in review_contributor.lower()
        data_dict['contributor'] = review_top_contrib
